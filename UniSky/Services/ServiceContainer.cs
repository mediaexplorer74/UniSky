...
/// <code>
/// ServiceContainer.Scoped.ConfigureServices(
...
/// <code>
/// ServiceContainer.Scoped.GetService&lt;ILogger&gt;().Log("Hello world!");
/// </code>
/// </summary>
public sealed partial class ServiceContainer : IServiceProvider
{
    /// <summary>
    /// Gets the default <see cref="Ioc"/> instance.
    /// </summary>
    public static ServiceContainer Default { get; } = new();
    private static ThreadLocal<IServiceScope> _scoped = new ThreadLocal<IServiceScope>(() => Default.CreateScope(), true);
    public static IServiceProvider Scoped => _scoped.Value.ServiceProvider;
